...
public class DisplayWarp extends JFrame implements Runnable
{
...
try {
        // Save as PNG
        File file = new File("warpimage.png");
        ImageIO.write(bufferedImage, "png", file);
    
        // Save as JPEG
        file = new File("warpimage.jpg");
...
widthorheight=(int)temp;
                              ...
                              g.setColor(new Color(red,green,blue));
                                   g.fillRect(xleft, yleft, widthorheight, 50*gd.numberofwarpyarns);
                                   xleft = xleft + widthorheight;
